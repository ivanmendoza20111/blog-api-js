                    ...
                    <div class="col-md-12">
                        <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                            <div class="card-body d-flex flex-column align-items-start">
                                <h3 class="mb-0">
                                    <a class="text-dark" href="post.html?id=${id}">${title} </a>  <span id="like-big-${id}" style="cursor:pointer;" class="like" data-id="${id}"  data-like="${response[i].liked}">&nbsp; ${like}</span>
                                </h3>`;
                            ...
                            resultado+=`
                                <p>By: <a href="user.html?id=${userId}"><strong class="d-inline-block mb-2 text-primary">${username}(${email})</strong></a></p>
                                
                                <div class="mb-1 text-muted">${createdAt}</div>
                                
                                    <p class="card-text mb-auto">${body}</p>
                                   <p> <a href="post.html?id=${id}">Continuar Leyendo</a> &nbsp; <i style="color:#e64980;" class="far fa-comments"></i> Comentarios (<span id="articulo-comment-${id}">${comment}</span>) &nbsp; <i class="far fa-eye"></i> Visitas (<span id="articulo-view-${id}">${views}</span>) &nbsp;  <i style="color:#fd7e14;" class="fas fa-star"></i> Likes (<span id="articulo-like-${id}" >${totalLikes}</span>)</p>
                                </div>
                            </div>
                        </div>
                    </div>
